    ...
    <div class="container">
       ...
       <div class="collapse navbar-collapse" id="Navbar">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a class="nav-link"  style="color: #28a7e9;"> ABOUT</a></li>
                <li class="nav-item"><a class="nav-link" href="Service.php"> SERVICES</a></li>
                <li class="nav-item"><a class="nav-link" href="Contact.php"> CONTACT</a></li>
                <button class="btn btn-default log-in" type="submit"><a href="Login.php" id="login">LOG-IN</a></button>
            </ul>
        </div>
    </div>
</nav>
<!-- end navigation -->
<?php
  echo '<script> var login = document.getElementById("log");</script>';
  session_start();
  if(empty($_SESSION['UserName'])){
    echo'<script>login.innerHTML="LOG-IN";</script>';
  }else{
    echo'<script>
